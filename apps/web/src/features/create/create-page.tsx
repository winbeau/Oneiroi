      ...
      <AnimatePresence initial={false}>
        {agentOpen && (
          <motion.div
            ...
            className="mx-auto mt-4 max-w-[760px] overflow-hidden"
    ...
    <main className="relative flex h-[calc(100vh-60px)] min-h-[620px] overflow-hidden">
      ...
      <section className="flex min-w-0 flex-1 flex-col bg-[var(--color-canvas)]">
        ...
        <div className="scrollbar-notion flex min-h-0 flex-1 flex-col overflow-y-auto">
          {conversationJobs.length === 0 ? (
            <div className="relative mx-auto flex w-full max-w-[1120px] flex-1 items-center justify-center overflow-hidden px-4 py-10 md:px-7 md:py-16">
              <div
                aria-hidden="true"
                className="pointer-events-none absolute left-[12%] top-[18%] size-64 rounded-full bg-[rgb(214_154_87_/_7%)] blur-3xl"
              />
              <div
                aria-hidden="true"
                className="pointer-events-none absolute bottom-[14%] right-[8%] size-72 rounded-full bg-[var(--color-accent-faint)] blur-3xl"
              />
            ...
            <>
              <div className="mx-auto w-full max-w-[1120px] flex-1 px-4 pb-2 pt-5 md:px-7 md:pt-7">
